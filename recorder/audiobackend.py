...
class AudioBackend(QtCore.QObject):
    ...
    new_data_available = QtCore.pyqtSignal(ndarray, float, dict)
    ...
    def __init__(self, logger):
        ...
        self.norm_coeff = float(max(abs(int16info.min), int16info.max))
    ...
    def handle_new_data(self, in_data, frame_count, input_time, input_overflow):
        ...
        floatdata_all_channels = intdata_all_channels.astype(float64) / self.norm_coeff
        ...
        self.new_data_available.emit(floatdata, input_time, {"overflow": input_overflow})
